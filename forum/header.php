...
// Forum Title
$gen_elements['<!-- forum_title -->'] = '<a href="../index.php">&laquo;&laquo; На главную</a><br/><p id="brd-title"><a href="'.forum_link($forum_url['index']).'">'.forum_htmlencode($forum_config['o_board_title']).'</a></p>';
